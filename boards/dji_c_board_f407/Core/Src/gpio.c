...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : IMU_ACCEL_CS_Pin */
  GPIO_InitStruct.Pin = IMU_ACCEL_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(IMU_ACCEL_CS_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : IMU_GYRO_CS_Pin */
  GPIO_InitStruct.Pin = IMU_GYRO_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(IMU_GYRO_CS_GPIO_Port, &GPIO_InitStruct);
